...
<div class="wrap">
  <div class="page_header">
    <div id="top_logo"><a href="/termproject1/main/iphonemarket.html">
...
<%
    ...
    try{
        ...
        if(multi.getParameter("CheckboxGroup2").equals("애플"))
        	pcode=1;
        else
        	pcode=2;
        ...
        Phone phone = new Phone(0, pcode, maker, mname, company, capacity, price, new java.util.Date(), pimage);
        dao.insert(conn, phone);
    } catch(Exception e){
...
%>               
                    ...
                    <table width="680" border="0" cellpadding="0" cellspacing="0" id="registerform">
                      ...
                      <tr>
                        <th><label for="modelfield">* 제조사</label></th>
                        <td><%= maker %></td>
                      </tr>
                      <tr>
                  	...
                  	상품정보가 등록되었습니다.<br><br> <a href = "searchPhone.jsp">리스트 보기</a>
                </div>
